...
\caption{\flabel{SeqApprx} Plot showing timescale seperation between the survival probability of a promoter in equilibrium, and with only one TF at contact. TF's come from the bulk in the order of seconds, while a rebinding event takes place in the order of micro seconds, as is shown in the inset.}
\end{figure}
