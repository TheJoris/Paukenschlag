...
To prove \eref{bsm_k}, we show that the initial condition and the time derivative of both the influx and the survival probability $S(t|z_0)$ are the same. The influx at a radiation boundary from an equilibrium is
\begin{equation}
