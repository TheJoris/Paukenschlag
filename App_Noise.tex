...
\end{eqnarray}
When we evaluate \eref{S_eqn} at $r_0=\sigma$, we see, using the Kolmogorov equation, that the time derivatives of both quantaties obey the same differential equation. Furthermore, in the limit $t \rightarrow 0$, both \eref{bsm_3} and \eref{bsm_k} equal. We conclude that \eref{bsm_k} must hold.
