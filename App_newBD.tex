...
For the backward move, $P_{\rm{u^*} \to \rm{u}}^{\rm move}(\vec{r},\Delta t|{\rm u^*})d\vec{r}$, the probability of ending up at $\vec{r}$, given that you started inside the reaction volume, is
\begin{multline}
